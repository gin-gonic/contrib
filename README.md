...
+ [gin-opentelemetry](https://github.com/open-telemetry/opentelemetry-go-contrib/tree/main/instrumentation/github.com/gin-gonic/gin/otelgin) - Gin middleware for OpenTelemetry, you can also use OpenTelemetry via [Alibaba Compile Time Auto Instrumentation](https://github.com/alibaba/opentelemetry-go-auto-instrumentation) and [OpenTelemetry Auto Instrumentation using eBPF](https://github.com/open-telemetry/opentelemetry-go-instrumentation) without changing any code
